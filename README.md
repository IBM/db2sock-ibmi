...
- Async APIs - high performing async CLI APIs for all new PASE languages
- JSON APIs - enable json only calls. Allows future REST DB2 called by any language on/off IBM i
