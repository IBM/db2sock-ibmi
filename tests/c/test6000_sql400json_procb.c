...
int main(int argc, char * argv[]) {
  ...
  sqlrc = SQLPrepare(hstmt, "call DB2JSON.DB2PROCB(?)", SQL_NTS);
  ...
  inlenutf8 = outlen;
  sqlrc = SQLBindParameter(hstmt, 1, SQL_PARAM_INPUT_OUTPUT, SQL_C_DEFAULT, parm_data_type, parm_precision, parm_scale, injsonutf8, 0, &inlenutf8);
  ...
  sqlrc = SQL400ToUtf8(hdbc, injsonutf8, inlen, outjson, outlen, eccsid);
  free(ptr1);
