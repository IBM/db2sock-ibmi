...
void main_execute(SQLHANDLE hstmt) {
  ...
  sqlrc = SQL400AddDesc(hstmt, 2, SQL400_DESC_PARM, (SQLPOINTER)&desc_parms);
  lang_check_sqlrc(SQL_HANDLE_STMT, hstmt, sqlrc, 1, &sqlcode);
  sqlrc = SQL400AddDesc(hstmt, 3, SQL400_DESC_PARM, (SQLPOINTER)&desc_parms);
  lang_check_sqlrc(SQL_HANDLE_STMT, hstmt, sqlrc, 1, &sqlcode);
  sqlrc = SQL400AddDesc(hstmt, 4, SQL400_DESC_PARM, (SQLPOINTER)&desc_parms);
  lang_check_sqlrc(SQL_HANDLE_STMT, hstmt, sqlrc, 1, &sqlcode);
  ...
  indPtr1 = strlen((SQLCHAR *)&prm1_utf8);
  sqlrc = SQL400AddCVar(1, SQL_PARAM_INPUT, SQL_C_CHAR, (SQLPOINTER) &prm1_utf8, &indPtr1, (SQLPOINTER) &call_parms ); 
  indPtr2 = strlen((SQLCHAR *)&prm2_utf8);
  sqlrc = SQL400AddCVar(2, SQL_PARAM_INPUT, SQL_C_CHAR, (SQLPOINTER) &prm2_utf8, &indPtr2, (SQLPOINTER) &call_parms ); 
  indPtr3 = strlen((SQLCHAR *)&prm3_utf8);
  sqlrc = SQL400AddCVar(3, SQL_PARAM_INPUT, SQL_C_CHAR, (SQLPOINTER) &prm3_utf8, &indPtr3, (SQLPOINTER) &call_parms );
  prm4 = malloc(desc_parms[3].pcbColDef);
  indPtr4 = desc_parms[3].pcbColDef;
  memset(prm4,0,desc_parms[3].pcbColDef);
  sqlrc = SQL400AddCVar(4, SQL_PARAM_INPUT, SQL_C_CHAR, (SQLPOINTER) prm4, &indPtr4, (SQLPOINTER) &call_parms ); 
