...
for name in test_pgms:
  ...
  test_var_dcl += 'TEST' + nbr + 'LIBDEPS32  = /QOpenSys/usr/lib/crt0.o $(LIBDEPALL) -llang400' + "\n"
  test_var_dcl += 'TEST' + nbr + 'PGM64      = ' + line + '_64' + "\n"
  test_var_dcl += 'TEST' + nbr + 'LIBOBJS64  = $(TEST' + nbr + 'LIBOBJS32)' + "\n"
  test_var_dcl += 'TEST' + nbr + 'LIBDEPS64  = /QOpenSys/usr/lib/crt0_64.o $(LIBDEPALL) -llang400' + "\n"
...
test_make += 'LIBEXPS            = -shared -Wl,-bE:liblang400.exp' + "\n"
test_make += 'LIBSHR32           = liblang400.a' + "\n"
test_make += 'LIBOBJ32           = shr.o' + "\n"
test_make += 'LIBDEPS32          = $(LIBDEPALL) -Wl,-brtl -Wl,-bnoquiet' + "\n"
test_make += 'LIBSHR64           = liblang400_64.a' + "\n"
test_make += 'LIBOBJ64           = shr_64.o' + "\n"
test_make += 'LIBDEPS64          = $(LIBDEPS32) -Wl,-brtl -Wl,-bnoquiet -maix64' + "\n"
test_make += '' + "\n"
