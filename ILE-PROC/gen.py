...
for z in range(1,byval_max_args+1):
  ...
  srvpgm_c_byval = ""
  srvpgm_c_byval += 'typedef struct fool16 {char hole[16]; } fool16_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool15 {char hole[15]; } fool15_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool14 {char hole[14]; } fool14_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool13 {char hole[13]; } fool13_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool12 {char hole[12]; } fool12_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool11 {char hole[11]; } fool11_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool10 {char hole[10]; } fool10_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool9 {char hole[9]; } fool9_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool8 {char hole[8]; } fool8_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool7 {char hole[7]; } fool7_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool6 {char hole[6]; } fool6_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool5 {char hole[5]; } fool5_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool4 {char hole[4]; } fool4_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool3 {char hole[3]; } fool3_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool2 {char hole[2]; } fool2_t;' + "\n"
  srvpgm_c_byval += 'typedef struct fool1 {char hole[1]; } fool1_t;' + "\n"
  srvpgm_c_byval += 'static int iNextArgv(ile_pgm_call_t* layout, int argc)'  + "\n"
  srvpgm_c_byval += '{'  + "\n"
  srvpgm_c_byval += '  int i = 0;'  + "\n"
  srvpgm_c_byval += '  int j = 0;'  + "\n"
  srvpgm_c_byval += '  for (i=0; i < ILE_PGM_MAX_ARGS; i++) {'  + "\n"
  srvpgm_c_byval += '    if (layout->argv[i]) {'  + "\n"
  srvpgm_c_byval += '      if (j == argc) {'  + "\n"
  srvpgm_c_byval += '        return i;'  + "\n"
  srvpgm_c_byval += '      }'  + "\n"
  srvpgm_c_byval += '      j++;'  + "\n"
  srvpgm_c_byval += '    }'  + "\n"
  srvpgm_c_byval += '  }'  + "\n"
  srvpgm_c_byval += '  return 0;'  + "\n"
  srvpgm_c_byval += '}'  + "\n"
