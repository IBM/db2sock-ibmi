...
for line in f:
  ...
  # { 
  # }
  PaseCliLibDB400_c_main += call_retv + ' ' + call_name + '(' + normal_call_args + ' )' + "\n"
  PaseCliLibDB400_c_main += "{" + "\n"
  PaseCliLibDB400_c_main += "  SQLRETURN sqlrc = SQL_SUCCESS;" + "\n"
  PaseCliLibDB400_c_main += "  if (i_am_big_chicken_flag) {" + "\n"
  PaseCliLibDB400_c_main += "    init_dlsym();" + "\n"
  PaseCliLibDB400_c_main += "  }" + "\n"
  # SQLRETURN SQLAllocEnv ( SQLHENV * phenv );
  if call_name == "SQLAllocEnv":
    PaseCliLibDB400_c_main += "  init_lock();" + "\n"
    PaseCliLibDB400_c_main += "  if (i_am_big_chicken_flag) {" + "\n"
    PaseCliLibDB400_c_main += "    sqlrc = " + chicken_call + call_name + '(' + normal_db400_args + ' );' + "\n"
    PaseCliLibDB400_c_main += "  } else {" + "\n"
    PaseCliLibDB400_c_main += "    sqlrc = " + actual_call + call_name + '(' + normal_db400_args + ' );' + "\n"
    PaseCliLibDB400_c_main += "  }" + "\n"
    PaseCliLibDB400_c_main += "  if (sqlrc == SQL_SUCCESS) {" + "\n"
    PaseCliLibDB400_c_main += "    init_table_ctor(*phenv, *phenv);" + "\n"
    PaseCliLibDB400_c_main += "  }" + "\n"
    PaseCliLibDB400_c_main += "  init_unlock();" + "\n"
  # SQLRETURN SQLAllocConnect ( SQLHENV  henv, SQLHDBC * phdbc );
    ...
    PaseCliLibDB400_c_main += "  }" + "\n"
    PaseCliLibDB400_c_main += "  if (sqlrc == SQL_SUCCESS) {" + "\n"
    PaseCliLibDB400_c_main += "    init_table_ctor(*phdbc, *phdbc);" + "\n"
    PaseCliLibDB400_c_main += "  }" + "\n"
    PaseCliLibDB400_c_main += "  init_unlock();" + "\n"
  # SQLRETURN SQLAllocStmt ( SQLHDBC  hdbc, SQLHSTMT * phstmt );
    ...
    PaseCliLibDB400_c_main += "  }" + "\n"
    PaseCliLibDB400_c_main += "  if (sqlrc == SQL_SUCCESS) {" + "\n"
    PaseCliLibDB400_c_main += "    init_table_ctor(*phstmt, hdbc);" + "\n"
    PaseCliLibDB400_c_main += "  }" + "\n"
    PaseCliLibDB400_c_main += "  init_unlock();" + "\n"
  # SQLRETURN SQLAllocHandle ( SQLSMALLINT  htype, SQLINTEGER  ihnd, SQLINTEGER * ohnd );
  elif call_name == "SQLAllocHandle":
    PaseCliLibDB400_c_main += "  switch (htype) {" + "\n"
    PaseCliLibDB400_c_main += "  case SQL_HANDLE_ENV:" + "\n"
    PaseCliLibDB400_c_main += "    init_lock();" + "\n"
    PaseCliLibDB400_c_main += "    if (i_am_big_chicken_flag) {" + "\n"
    PaseCliLibDB400_c_main += "      sqlrc = " + chicken_call + call_name + '(' + normal_db400_args + ' );' + "\n"
    PaseCliLibDB400_c_main += "    } else {" + "\n"
    ...
    PaseCliLibDB400_c_main += "    }" + "\n"
    PaseCliLibDB400_c_main += "    if (sqlrc == SQL_SUCCESS) {" + "\n"
    PaseCliLibDB400_c_main += "      init_table_ctor(*ohnd, *ohnd);" + "\n"
    PaseCliLibDB400_c_main += "    }" + "\n"
    PaseCliLibDB400_c_main += "    init_unlock();" + "\n"
    PaseCliLibDB400_c_main += "    break;" + "\n"
    PaseCliLibDB400_c_main += "  case SQL_HANDLE_DBC:" + "\n"
    PaseCliLibDB400_c_main += "    init_lock();" + "\n"
    PaseCliLibDB400_c_main += "    if (i_am_big_chicken_flag) {" + "\n"
    PaseCliLibDB400_c_main += "      sqlrc = " + chicken_call + call_name + '(' + normal_db400_args + ' );' + "\n"
    PaseCliLibDB400_c_main += "    } else {" + "\n"
    ...
    PaseCliLibDB400_c_main += "    init_unlock();" + "\n"
    PaseCliLibDB400_c_main += "    break;" + "\n"
    PaseCliLibDB400_c_main += "  case SQL_HANDLE_STMT:" + "\n"
    PaseCliLibDB400_c_main += "    init_lock();" + "\n"
    PaseCliLibDB400_c_main += "    if (i_am_big_chicken_flag) {" + "\n"
    PaseCliLibDB400_c_main += "      sqlrc = " + chicken_call + call_name + '(' + normal_db400_args + ' );' + "\n"
    PaseCliLibDB400_c_main += "    } else {" + "\n"
    ...
    PaseCliLibDB400_c_main += "    }" + "\n"
    PaseCliLibDB400_c_main += "    if (sqlrc == SQL_SUCCESS) {" + "\n"
    PaseCliLibDB400_c_main += "      init_table_ctor(*ohnd, ihnd);" + "\n"
    PaseCliLibDB400_c_main += "    }" + "\n"
    PaseCliLibDB400_c_main += "    init_unlock();" + "\n"
    PaseCliLibDB400_c_main += "    break;" + "\n"
    PaseCliLibDB400_c_main += "  case SQL_HANDLE_DESC:" + "\n"
    PaseCliLibDB400_c_main += "    init_lock();" + "\n"
    PaseCliLibDB400_c_main += "    if (i_am_big_chicken_flag) {" + "\n"
    PaseCliLibDB400_c_main += "      sqlrc = " + chicken_call + call_name + '(' + normal_db400_args + ' );' + "\n"
    PaseCliLibDB400_c_main += "    } else {" + "\n"
  ...
  # SQLRETURN SQLFreeConnect ( SQLHDBC  hdbc );
    ...
    PaseCliLibDB400_c_main += "  }" + "\n"
    PaseCliLibDB400_c_main += "  if (sqlrc == SQL_SUCCESS) {" + "\n"
    PaseCliLibDB400_c_main += "    init_table_dtor(hdbc);" + "\n"
    PaseCliLibDB400_c_main += "  }" + "\n"
    PaseCliLibDB400_c_main += "  init_unlock();" + "\n"
  # SQLRETURN SQLFreeStmt ( SQLHSTMT  hstmt, SQLSMALLINT  fOption );
    ...
    PaseCliLibDB400_c_main += "  }" + "\n"
    PaseCliLibDB400_c_main += "  if (sqlrc == SQL_SUCCESS) {" + "\n"
    PaseCliLibDB400_c_main += "    init_table_dtor(hstmt);" + "\n"
    PaseCliLibDB400_c_main += "  }" + "\n"
    PaseCliLibDB400_c_main += "  init_unlock();" + "\n"
  # SQLRETURN SQLFreeHandle ( SQLSMALLINT  htype, SQLINTEGER  hndl );
    ...
    PaseCliLibDB400_c_main += "    }" + "\n"
    PaseCliLibDB400_c_main += "    if (sqlrc == SQL_SUCCESS) {" + "\n"
    PaseCliLibDB400_c_main += "      init_table_dtor(hndl);" + "\n"
    PaseCliLibDB400_c_main += "    }" + "\n"
    PaseCliLibDB400_c_main += "    init_unlock();" + "\n"
    PaseCliLibDB400_c_main += "    break;" + "\n"
    PaseCliLibDB400_c_main += "  case SQL_HANDLE_STMT:" + "\n"
    ...
    if argtype1st == "SQLHENV":
      ...
      PaseCliLibDB400_c_main += "  init_table_lock(" + argname1st + ", 0);" + "\n"
      if actual_call == "custom_":
        PaseCliLibDB400_c_main += "  sqlrc = " + actual_call + call_name + '(' + normal_db400_args + ' );' + "\n"
      else:
        PaseCliLibDB400_c_main += "  if (i_am_big_chicken_flag) {" + "\n"
        ...
        PaseCliLibDB400_c_main += "    sqlrc = " + actual_call + call_name + '(' + normal_db400_args + ' );' + "\n"
        PaseCliLibDB400_c_main += "  }" + "\n"
      PaseCliLibDB400_c_main += "  init_table_unlock(" + argname1st + ", 0);" + "\n"
    elif argtype1st == "SQLHSTMT":
      PaseCliLibDB400_c_main += "  init_table_lock(" + argname1st + ", 1);" + "\n"
      if actual_call == "custom_":
        PaseCliLibDB400_c_main += "  sqlrc = " + actual_call + call_name + '(' + normal_db400_args + ' );' + "\n"
      else:
        PaseCliLibDB400_c_main += "  if (i_am_big_chicken_flag) {" + "\n"
        ...
        PaseCliLibDB400_c_main += "    sqlrc = " + actual_call + call_name + '(' + normal_db400_args + ' );' + "\n"
        PaseCliLibDB400_c_main += "  }" + "\n"
      PaseCliLibDB400_c_main += "  init_table_unlock(" + argname1st + ", 1);" + "\n"
